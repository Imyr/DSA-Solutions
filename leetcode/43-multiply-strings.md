# 43. Multiply Strings
- [Submission](https://leetcode.com/submissions/detail/1114366580/)
...
impl Solution {
    ...
    pub fn multiply(num1: String, num2: String) -> String {
        ...
        while !num2.is_empty() {
            ...
            let mut product = Solution::mul(num1.clone(), multiplier);
            for _ in 0..zeroes {
                product.push(0);
            }
            final_product = Solution::add(final_product, product);
            zeroes += 1;
        }
